...
import re
import numpy as np
from cartoonpy.video.VideoClip import VideoClip, TextClip
from cartoonpy.tools import cvsecs
from cartoonpy.decorators import convert_to_seconds
...
class SubtitlesClip(VideoClip):
    ...
    >>> from cartoonpy.video.tools.subtitles import SubtitlesClip
    >>> from cartoonpy.video.io.VideoFileClip import VideoFileClip
