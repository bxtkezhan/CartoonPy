...
from cartoonpy.decorators import (convert_to_seconds, use_clip_fps_by_default)
...
def manual_tracking(clip, t1=None, t2=None, fps=None, nobjects = 1,
    ...
    >>> from cartoonpy.tools.tracking import manual_tracking
    ...
    >>> from cartoonpy.tools.tracking import Trajectory
