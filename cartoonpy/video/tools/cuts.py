...
the cuts in CartoonPy """

from collections import defaultdict
from cartoonpy.decorators import use_clip_fps_by_default
import numpy as np
...
class FramesMatches(list):
    ...
    def from_clip(clip, dist_thr, max_d, fps=None):
        ...
        >>> from cartoonpy.video.tools.cuts import find_matching_frames
        ...
        clip
          A CartoonPy video clip, possibly transformed/resized
