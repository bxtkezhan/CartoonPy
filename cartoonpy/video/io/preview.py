...
from cartoonpy.decorators import (requires_duration, convert_masks_to_RGB)
from cartoonpy.tools import cvsecs


pg.init()
pg.display.set_caption('CartoonPy')
...
def show(clip, t=0, with_mask=True, interactive=False):
    ...
    if with_mask and (clip.mask is not None):
        import cartoonpy.video.compositing.CompositeVideoClip as cvc
