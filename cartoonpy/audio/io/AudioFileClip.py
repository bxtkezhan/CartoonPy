...
from cartoonpy.audio.AudioClip import AudioClip
from cartoonpy.audio.io.readers import FFMPEG_AudioReader
...
from cartoonpy.config_defaults import TTS_TOK_PARAMS, AUDIO_PARAMS
...
class AudioTTSClip(AudioFileClip):
    ...
    def __init__(self, txt, filename='__temp__.mp3',
        ...
        for i in range(5):
            sound = tts(tok_params, txt, aud_params)
            if sound:
