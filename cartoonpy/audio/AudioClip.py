import os
import numpy as np
from cartoonpy.audio.io.ffmpeg_audiowriter import ffmpeg_audiowrite
from cartoonpy.decorators import requires_duration
from cartoonpy.tools import (deprecated_version_of,
                           extensions_dict)
    ...
    def write_audiofile(self,filename, fps=44100, nbytes=2,
        ...
        if codec is None:
            ...
            try:
                ...
                raise ValueError("CartoonPy couldn't find the codec associated "
