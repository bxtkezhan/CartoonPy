from cartoonpy.decorators import audio_video_fx
...
def volumex(clip, factor):
    ...
    This effect is loaded as a clip method when you use cartoonpy.editor,
    ...
    >>> newclip = clip.volumex(2) # only if you used "cartoonpy.editor"
    """ 
